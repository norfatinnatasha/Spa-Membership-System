...
<form id="form1" name="form1" method="post" action="engineEditService.php">
		<table width="830" border="1" style="background-color:#7D6AF4">
			<tr>
				<td width="92">Service ID</td>
				<td width="527"><label for="txtServiceID"></label>
					<input type="text" name="txtServiceID" id="txtServiceID"  value="<?php echo $service_id ?>" readonly="readonly"/></td>
			</tr>
			<tr>
				<td>Service Name</td>
				<td><label for="txtName"></label>
					<input type="text" name="txtName" id="txtName" value="<?php echo $data["service_name"]?>"/></td>
			</tr>
			<tr>
				<td>Price (RM)</td>
				<td><label for="txtPrice"></label>
				<input type="double" name="txtPrice" id="txtPrice" value="<?php echo $data["service_price"]?>"/></td>
			</tr>
			<tr>
				<td colspan="2"><input type="submit" class = "button button-warning" name="smtSend" onClick="return confirm ('Update service details?');" id="smtSend" value="SAVE" /></td>
			</tr>
		</table>
		</form></center>
