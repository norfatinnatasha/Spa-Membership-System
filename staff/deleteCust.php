...
if(isset($_SESSION["log"]) && ($_SESSION["log"]==2))
{
	if(isset($_GET['cust_id']))
	{
		...
		<form id="form1" name="form1" method="post" action="engineDelCust.php">
		  <table width="635" border="1">
			<tr>
			  <td width="92">Customer ID</td>
			  <td width="527"><?php echo $cust_id ?>
							  <input type="hidden" name="cust_id" id="cust_id"  value="<?php echo $cust_id ?>"/></td>
			</tr>
			<tr>
			  <td>Name</td>
			...
			<tr>
			  <td>Gender</td>
			  <td><?php echo $data["cust_gender"]?></td>
			</tr>
			<tr>
			  <td>Phone Number</td>
			  <td><?php echo $data["cust_phonenum"]?></td>
			</tr>
			<tr>
			  <td>Date of Birth</td>
			  <td><?php echo $data["cust_birthdate"]?></td>
			</tr>
			<tr>
			  <td>Registration Date</td>
			  <td><?php echo $data["cust_regdate"]?></td>
			</tr>
			<tr>
			  <td>Membership</td>
			...
			<tr>
			  <td colspan="2"><input type="submit" class = "button button-warning" onClick="return confirm ('Delete customer details?');" name="smtSend" id="smtSend" value="DELETE" /></td>
			</tr>
		  </table>
		</form> </center>
<?php
