...
<form id="form1" name="form1" method="post" action="engineAddCategory.php">
		<table width="400" border="1" style="background-color:#7D6AF4">
			<tr>
				<td>Category Name</td>
			...
			<tr>
				<td colspan="2"><input type="submit" class = "button button-warning" name="smtSend" id="smtSend" onClick="return confirm ('Successfully added new category.');" value="SAVE" />
