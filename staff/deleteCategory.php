...
if(isset($_SESSION["log"]) && ($_SESSION["log"]==2))
{
	if(isset($_GET['type_id']))
	{
		...
		<form id="form1" name="form1" method="post" action="engineDelCategory.php">
		  <table width="635" border="1">
			<tr>
			  <td width="92">Category ID</td>
			  <td width="527"><?php echo $type_id ?>
			...
			<tr>
			  ...
			  <td><?php echo $data["price_session"]?></td>
			</tr>
			<tr>
			  <td colspan="2"><input type="submit" class = "button button-warning" name="smtSend" id="smtSend" onClick="return confirm ('Delete membership details?');" value="DELETE" /></td>
			</tr>
		  </table>
		</form> </center>
<?php
